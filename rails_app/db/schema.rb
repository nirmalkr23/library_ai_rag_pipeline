...
ActiveRecord::Schema[8.0].define(version: 2026_06_14_044501) do
  ...
  create_table "chat_histories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["book_id"], name: "index_chat_histories_on_book_id"
  ...
  add_foreign_key "book_chunks", "books", on_delete: :cascade
  add_foreign_key "books", "users"
  add_foreign_key "chat_histories", "books"
